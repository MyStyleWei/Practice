...
public class TestXfermode extends View{
    ...
    public TestXfermode(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    ///onDraw()方法 创建图层 int layer = canvas.savaLayer(left,top,right,height,paint,flags)

//    线绘制dst  paint.setXfermode(mode)
//        绘制src paint.setXformode(null)
//        还原画布  cavans,restoreToCount()
